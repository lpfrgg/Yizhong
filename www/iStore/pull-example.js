...
(function pullPagePullImplementation($) {
  ...
  var pullDownGeneratedCount = 0,
      ...
      listSelector = "div.mainPage ul.ui-listview",
  ...
  $(document).delegate("div.mainPage", "pageinit", 
...
(function shortPullPagePullImplementation($) { 
  ...
  var pullDownGeneratedCount = 0,
    pullUpGeneratedCount = 0,
    listSelector = "div.short-mainPage ul.ui-listview",
    lastItemSelector = listSelector + " > li:last-child";
  ...
  $(document).delegate("div.short-mainPage", "pageinit", 
